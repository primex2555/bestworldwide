...
export default function ETH() {
  ...
  const [copyText, setCopyText] = useState(
    "0xcce9ccb76b5ca42fed4e98b228fab6ae7a24c474",
  );
  ...
  useEffect(() => {
    fetch("https://api.coincap.io/v2/assets/ethereum")
      ...
      .then((data) => setEth(data.data.priceUsd))
          ...
          <Complete>
            <div className="text-textwhite text-center">
              <div className="align-items-center flex justify-center py-2">
                <div className="bg-theader p-2">
                  <Image src={"/ethqr.png"} width={200} height={200} alt={""} />
                </div>
              </div>
              ...
              <p className="pb-4 text-base">{divAppearance / eth} ETH</p>
              <p className="text-base font-bold">ETHEREUM WALLET ADDRESS</p>
              <div className="my-2 flex items-center gap-x-2">
                <Input
                  type="text"
                  value={"0xcce9ccb76b5ca42fed4e98b228fab6ae7a24c474"}
                  disabled
                />

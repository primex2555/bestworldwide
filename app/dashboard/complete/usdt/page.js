...
export default function BTC() {
  ...
  const [copyText, setCopyText] = useState(
    "TABhqvdiuh7PkeCcC2midNDhU1Lu6ziBpM",
  );
  ...
  useEffect(() => {
    fetch("https://api.coincap.io/v2/assets/tether")
      ...
      .then((data) => setUsdt(data.data.priceUsd))
        ...
        <GridContainer>
          <Complete>
            <div className="text-textwhite text-center">
              ...
              <p className="pb-4 text-base">{divAppearance / usdt} USDT</p>
              <p className="text-base font-bold">USDT WALLET ADDRESS</p>{" "}
              <div className="my-2 flex items-center gap-x-2">
                <Input
                  type="text"
                  value={"TABhqvdiuh7PkeCcC2midNDhU1Lu6ziBpM"}
                  disabled
                />
